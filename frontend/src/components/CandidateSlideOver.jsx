...
/**
 * Full-report panel for one candidate.
 *
 * Rendered inside the caller's <AnimatePresence>, which owns the mount/unmount
 * transition. Wrapping the panel in a second AnimatePresence here would swallow
 * the exit animation: the inner instance never sees its children removed, it is
 * simply unmounted along with them.
 */
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8">
          ...
          <div className="flex justify-center">
            <CircularScore key={candidate.id} score={candidate.score} label={candidate.label} size={152} />
          </div>
